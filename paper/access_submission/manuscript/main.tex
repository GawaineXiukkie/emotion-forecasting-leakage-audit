...
This work was carried out using the authors' own computing resources; no external funding was
...
\begin{IEEEbiographynophoto}{Dai-Qiao Zhang}
is with the School of Mathematical Sciences, Universiti Sains Malaysia, Penang, Malaysia.
\end{IEEEbiographynophoto}

\begin{IEEEbiographynophoto}{Tien-Ping Tan}
is with the School of Computer Sciences, Universiti Sains Malaysia, Penang, Malaysia.
\end{IEEEbiographynophoto}
